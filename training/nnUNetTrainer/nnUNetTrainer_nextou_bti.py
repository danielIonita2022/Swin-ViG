...
class nnUNetTrainer_NexToU_BTI_Synapse(nnUNetTrainer_NexToU):
    ...
    def _build_loss(self):
        ...
        exclusion_list = [[[1, 3, 5, 7, 8, 10, 12, 13, 14, 15], [2, 4, 6, 9, 11]], [[1, 3, 10, 12, 14, 15],
                          [5, 7, 8, 13]], [[1, 3, 14, 15], [10, 12]], [[1, 3], [14, 15]], [1, 3],
                          [14, 15], [10, 12], [[5, 8], [7, 13]], [5, 8], [7, 13], [[4, 6], [2, 9, 11]],
                          [4, 6], [[2], [9, 11]], [9, 11]]
